...
import com.ouanixi.beatthecharts.transitions.ScreenTransitionFade;
...
public class MenuScreen extends AbstractGameScreen{
    ...
    private Stage stage;
    private Skin skinBeatTheCharts;
    ...
    private void rebuildStage(){
        skinBeatTheCharts = new Skin(Gdx.files.internal(Constants.SKIN_BEATTHECHARTS_UI),
    ...
    private Table buildBackgroundLayer () {
        ...
        imgBackground = new Image(skinBeatTheCharts, "background");
        layer.addActor(imgBackground);
        imgBackground.setScale(1.5f);
        return layer;
    }

    private Table buildObjectsLayer () {
        Table layer = new Table();
        imgCoins = new Image(skinBeatTheCharts, "coins");
        layer.addActor(imgCoins);
        imgCoins.setOrigin(imgCoins.getWidth() / 2,imgCoins.getHeight() / 2);
        imgCoins.addAction(sequence(moveTo(135, -20),scaleTo(0, 0),fadeOut(0),delay(1.5f),
                parallel(moveBy(0, 100, 0.5f, Interpolation.swingOut), scaleTo(1.0f, 1.0f, 0.25f, Interpolation.linear), alpha(1.0f, 0.5f))));

        imgKenny = new Image(skinBeatTheCharts, "kenny");
        layer.addActor(imgKenny);
        imgKenny.setPosition(400,100); //imgKenny.addAction(sequence(moveTo(655, 610), delay(1.0f),moveBy(-70, -100, 0.5f, Interpolation.fade), moveBy(-100, -50, 0.5f, Interpolation.fade), moveBy(-150, -300, 1.0f, Interpolation.elasticIn)));
        return layer;
    }
    ...
    private Table buildLogosLayer () {
        ...
        layer.left().top();
        // + Game Logo
        imgLogo = new Image(skinBeatTheCharts, "logo");
        layer.add(imgLogo);
        layer.row().expandY();
        // + Info Logos
        imgInfo = new Image(skinBeatTheCharts, "info");
    ...
    private Table buildControlsLayer () {
        ...
        layer.right().bottom();
        // + Play Button
        btnMenuPlay = new Button(skinBeatTheCharts, "play");
        ...
        layer.row();
        // + Options Button
        btnMenuOptions = new Button(skinBeatTheCharts, "options");
    ...
    private Table buildOptWinSkinSelection () {
        ...
        // + Skin preview image
        imgCharSkin = new Image(Assets.instance.kenny.kenny);
